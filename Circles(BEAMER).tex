...
\onslide<3->{\color{blue}\textbf{Vertex: }$\bm{(2,-4)}$}	\qquad
\onslide<4->{\color{red}\textbf{Vertex: }$\bm{(3,-9)}$}	
\onslide<5->{\[{\color{blue}\bm{(x-2)^2}} + {\color{red}\bm{(y-3)^2}} = 23 + |-4| + |-9|\]}	
...
\onslide<3->{\color{blue}\textbf{Vertex: }$\bm{(-8,-64)}$}	\qquad
\onslide<4->{\color{red}\textbf{Vertex: }$\bm{(4,-16)}$}	
\onslide<5->{\[{\color{blue}\bm{(x+8)^2}} + {\color{red}\bm{(y-4)^2}} = 1 + |-64| + |-16|\]}	
\onslide<6->{\[(x+8)^2+(y-4)^2=81\]}	\\
\onslide<7->{Center: $(-8,4)$ \quad Radius: 9}
\end{frame}

\begin{frame}{Example 2}
(c)	\quad $x^2-10x+y^2+2y+14=0$ \onslide<2->{$\quad \longrightarrow x^2-10x+y^2+2y=-14$}
\onslide<3->{\[{\color{blue}\bm{x^2 - 10x}} \qquad + {\color{red}\bm{y^2 + 2y}} \qquad = 1\]} 
\onslide<4->{\color{blue}\textbf{Vertex: }$\bm{(5,-25)}$}	\qquad
\onslide<5->{\color{red}\textbf{Vertex: }$\bm{(-1,-1)}$}	
\onslide<6->{\[{\color{blue}\bm{(x-5)^2}} + {\color{red}\bm{(y+1)^2}} = 14 + |-25| + |-1|\]}	
