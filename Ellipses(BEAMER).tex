...
\end{center}
\onslide<2->{Center at $(3,0)$} \\[8pt]
\onslide<3->{$a = \pm 7$}   \onslide<4->{$\longrightarrow a^2 = 49$} \\[8pt]
\onslide<5->{$c = \pm 2\sqrt{6}$}   \onslide<6->{$\longrightarrow c^2 = 24$}    
\begin{align*}
...
\onslide<2->{\[\frac{(x-3)^2}{49} + \frac{y^2}{25} = 1\]}
\end{frame}

\begin{frame}{Example 3}
(b) Vertices at $(-6,2) \text{ and } (-6,-22)$, and co-vertices at $(-5,-10) \text{ and } (-7,-10)$    \newline\\
\onslide<2->{Center at $(-6,-10)$} \\[8pt]
\onslide<3->{$a = \pm 12$} \onslide<4->{$\longrightarrow a^2 = 144$} \\[8pt]
\onslide<5->{$b = \pm 1$} \onslide<6->{$\longrightarrow b^2 = 1$} 
\onslide<6->{\[(x+6)^2+\frac{(y+10)^2}{144} = 1\]}
\end{frame}

\begin{frame}{Example 3}
(c) Center: $(0,2)$, Vertex: $(-12,2)$, Focus: $(6\sqrt{3},2)$  \newline\\
\onslide<2->{$a = \pm 12$} \onslide<3->{$\longrightarrow a^2 = 144$} \\[8pt]
\onslide<4->{$c = \pm 6\sqrt{3}$} \onslide<5->{$\longrightarrow c^2 = 108$}
\begin{align*}
...
\onslide<2->{\[\frac{x^2}{144} + \frac{(y-2)^2}{36} = 1\]}
\end{frame}
